...
def source_tag(
    ...
    validation_ratio: float = typer.Option(DataSplitConfig.validation_ratio, help="Validation split ratio."),
    test_ratio: float = typer.Option(DataSplitConfig.test_ratio, help="Test split ratio."),
    train_sft_ratio: float = typer.Option(DataSplitConfig.train_sft_ratio, help="Train-SFT split ratio."),
    train_dpo_ratio: float = typer.Option(DataSplitConfig.train_dpo_ratio, help="Train-DPO split ratio."),
