...
def build_teacher_prompt(
    *,
    ...
    return (
        ...
        "9) For unanswerable cases, the rationale must briefly identify what information is missing, ambiguous, or contradictory in the provided knowledge.\n"
        f"10) {answer_guidance}\n\n"
        f"{reference_block}"
        "JSON schema:\n"
        f"{_schema_example()}\n\n"
