...
def build_teacher_prompt(
    *,
    ...
    return (
        ...
        "Requirements:\n"
        "1) Use the field order: answerability, evidence, answer, confidence.\n"
        "2) Every evidence quote must be copied from the provided knowledge.\n"
        "3) When the question is answerable, cite evidence and answer directly.\n"
        "4) When the question is unanswerable, use an allowed refusal template and keep evidence as [].\n"
        f"5) {answer_guidance}\n\n"
