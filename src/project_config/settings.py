...
class TrainingSettings:
    ...
    max_validation_answerable_samples: int = 800
    max_validation_unanswerable_samples: int = 200
    max_test_answerable_samples: int = 800
    max_test_unanswerable_samples: int = 200
    max_prompt_tokens: int = 512
    max_completion_tokens: int = 512
