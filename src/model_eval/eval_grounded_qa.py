...
def _spearman(xs: Sequence[float], ys: Sequence[float]) -> Optional[float]:
    ...
    return _pearson(ranked_x, ranked_y)
...
def _evaluate_one_model(
    *,
    ...
    confidence_bucket: Dict[str, Dict[str, List[float]]] = {
        "high": {"answerability": [], "correctness": [], "semantic_yes": [], "semantic_margin": []},
        "medium": {"answerability": [], "correctness": [], "semantic_yes": [], "semantic_margin": []},
        "low": {"answerability": [], "correctness": [], "semantic_yes": [], "semantic_margin": []},
    }
    ...
    for item in prepared:
        ...
        if parse_ok and is_pred_answerable:
            ...
            if correctness_report is not None:
                correctness_total += 1
                correctness_ok += int(correctness_report.ok)
    ...
    metrics = {
        ...
        "correctness_rate": _safe_rate(correctness_ok, correctness_total),
    ...
    confidence_metrics = {
        "correlations": {
            ...
            "correctness_on_pred_answerable": {
        ...
        "buckets": {
            label: {
                ...
                "correctness_rate_on_pred_answerable": _safe_mean(values["correctness"]),
